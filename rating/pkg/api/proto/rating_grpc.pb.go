...
const (
	MentorService_MethodMentorRating_FullMethodName = "/rating.MentorService/MethodMentorRating"
	MentorService_NewMentor_FullMethodName          = "/rating.MentorService/NewMentor"
)
...
var MentorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rating.MentorService",
